...
4. `pactagent-api`, `pactagent-worker-infrastructure`, and `pactagent-web` receive the new digest references independently.
...
kubectl -n pactagent rollout history deployment/pactagent-worker-infrastructure
